...
config.colors = {
  ...
  brights = {
    ...
    '#f38ba8',                        -- Red
    '#a6e3a1',                        -- Green
    '#fab387',                        -- Peach (bright orange/yellow)
    '#89b4fa',                        -- Blue
    '#f5c2e7',                        -- Pink
    '#94e2d5',                        -- Teal
  ...
  -- Override specific 256-color palette entries
  indexed = {
    [208] = '#fab387', -- Orange -> Peach
    [214] = '#fab387', -- Orange variant -> Peach
  },
}
